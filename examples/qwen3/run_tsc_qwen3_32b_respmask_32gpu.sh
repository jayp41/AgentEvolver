...
log_file="logs/qwen3/qwen3_32b_sparse_sem_turbo_bad0.2_negbad-0.2_respmask1_${current_time}.log"
...
ray job submit --address="$RAY_ADDRESS" \
    ...
    trainer.experiment_name="qwen3_32b_sparse_sem_turbo_bad0.2_negbad-0.2_respmask1" \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=20 \
    trainer.total_epochs=20 \
    trainer.val_before_train=True \
    trainer.validation_data_dir="experiments/exp_qwen3_32b_sparse_sem_turbo_bad0.2_negbad-0.2_respmask1_${current_time}/validation_log" \
    trainer.rollout_data_dir="experiments/exp_qwen3_32b_sparse_sem_turbo_bad0.2_negbad-0.2_respmask1_${current_time}/rollout_log" \
